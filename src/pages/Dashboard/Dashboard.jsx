...
export default function Page() {
  const metrics = [
    { title: "Total Users", value: 2345, icon: "bi-people-fill", color: "#4e73df" },
    { title: "Businesses", value: 768, icon: "bi-building", color: "#1cc88a" },
    { title: "Categories", value: 22, icon: "bi-grid-1x2-fill", color: "#36b9cc" },
  ];
        ...
        <div className="dashboard-content p-4">
          ...
          <div className="dashboard-metrics d-flex gap-3 mb-5">
            {metrics.map((item, idx) => (
              <div key={idx} className="dashboard-card" style={{ borderLeft: `5px solid ${item.color}` }}>
