...
const BookedTickets = () => {
  ...
  const fetchTickets = async () => {
    ...
    try {
      setLoading(true);
      const response = await getBookedTicketsByEventId(
        selectedEvent,
        pagination.current_page,
        pagination.per_page,
        debouncedSearchTerm,
  ...
  return (
    <>
      <Table
        PageTitle="🎟️ Booked Tickets Management"
        ...
        handleAdd={null} // No add functionality for booked tickets
        ...
        {selectedEvent ? (
          ...
          <div className="text-center text-muted mt-5 mb-5">
            ...
            <p className="text-muted">
              Choose an event from the dropdown above to see its booked tickets.
            </p>
          </div>
        )}
      </Table>
